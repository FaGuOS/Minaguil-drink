...
ActiveRecord::Schema.define(version: 2024_06_07_085013) do
  ...
  create_table "hidden_posts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_hidden_posts_on_post_id"
    t.index ["user_id"], name: "index_hidden_posts_on_user_id"
  end
  ...
  create_table "yeses", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_yeses_on_post_id"
    t.index ["user_id"], name: "index_yeses_on_user_id"
  end
  ...
  add_foreign_key "hidden_posts", "posts"
